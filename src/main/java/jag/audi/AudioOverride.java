...
public class AudioOverride extends Node {
    final Vorbis8[] aClass5_Sub10_Sub1Array1143;
    ...
    public AudioOverride(byte[] var1) {
        ...
        int var6 = 0;
        while (var2.payload[var6 + var2.caret] != 0) {
            ++var6;
        }
        ...
        int var9 = 0;
        while (var2.payload[var9 + var2.caret] != 0) {
            ++var9;
        }
        ...
        for (var31 = 0; var31 < 128; ++var31) {
            if (this.anIntArray692[var31] != 0) {
                ...
                this.aAudioOverrideEffectArray1139[var31] = var30;
                --var24;
            }
        }
    ...
    public static void clear() {
        VarDefinition.aReferenceCache701.clear();
    }
