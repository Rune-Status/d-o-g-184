...
public class AsyncOutputStream implements Runnable {
    ...
    public static void processMinimapClick(InterfaceComponent component, int x, int y) {
        ...
        if (image.contains(relativeX, relativeY)) {
            ...
            OutgoingPacket packet = OutgoingPacket.prepare(OutgoingPacketMeta.WALK_MAP, client.netWriter.encryptor);
            packet.buffer.p1(18);
            ...
            packet.buffer.p2(client.cameraY);
            packet.buffer.p1(57);
            packet.buffer.p1(0);
            packet.buffer.p1(0);
            packet.buffer.p1(89);
