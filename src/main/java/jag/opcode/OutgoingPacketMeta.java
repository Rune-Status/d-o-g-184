...
public class OutgoingPacketMeta implements OutgoingPacketProtocol {
    ...
    public static final OutgoingPacketMeta anOutgoingPacketMeta78;
    ...
    public static final OutgoingPacketMeta anOutgoingPacketMeta51;
    ...
    public static final OutgoingPacketMeta anOutgoingPacketMeta22;
    public static final OutgoingPacketMeta anOutgoingPacketMeta56;
    ...
    public static final OutgoingPacketMeta anOutgoingPacketMeta97;
    ...
    public static final OutgoingPacketMeta anOutgoingPacketMeta33;
    public static final OutgoingPacketMeta WRITE_SOME_STRING_3617;
    public static final OutgoingPacketMeta WALK_MAP;
    public static final OutgoingPacketMeta PLAYER_ACTION_4;
    public static final OutgoingPacketMeta IDLE_WRITE;
    public static final OutgoingPacketMeta MINIMAP_DATA;
    public static final OutgoingPacketMeta MOUSE_ACTION;
    public static final OutgoingPacketMeta DRAGGED_COMPONENT;
    public static final OutgoingPacketMeta anOutgoingPacketMeta11;
    public static final OutgoingPacketMeta INTERFACE_ACTION_8;
    public static final OutgoingPacketMeta anOutgoingPacketMeta2;
    ...
    public static final OutgoingPacketMeta WRITE_SOME_STRING_3105;
    public static final OutgoingPacketMeta WRITE_SOME_SHORT_3115;
    public static final OutgoingPacketMeta WRITE_SOME_STRING_3604;
    public static final OutgoingPacketMeta WRITE_SOME_STRING_NONEMPTY_3619;
    public static final OutgoingPacketMeta WRITE_SOME_STRING_5009;
    public static final OutgoingPacketMeta WRITE_SOME_STRING_5002;
    public static final OutgoingPacketMeta WRITE_SOME_STRING_3116;
    public static final OutgoingPacketMeta anOutgoingPacketMeta21;
    ...
    static {
        ...
        anOutgoingPacketMeta78 = new OutgoingPacketMeta(7, 9);
        ...
        anOutgoingPacketMeta56 = new OutgoingPacketMeta(13, 0);
        ITEM_ACTION_3 = new OutgoingPacketMeta(14, 8);
        anOutgoingPacketMeta97 = new OutgoingPacketMeta(15, 1);
        ...
        WRITE_SOME_STRING_3617 = new OutgoingPacketMeta(22, -1);
        IDLE_WRITE = new OutgoingPacketMeta(23, 0);
        PICKABLE_ACTION_4 = new OutgoingPacketMeta(24, 7);
        MINIMAP_DATA = new OutgoingPacketMeta(25, 4);
        ...
        anOutgoingPacketMeta2 = new OutgoingPacketMeta(32, -1);
        ...
        anOutgoingPacketMeta11 = new OutgoingPacketMeta(40, -2);
        ...
        anOutgoingPacketMeta22 = new OutgoingPacketMeta(44, 13);
        ...
        anOutgoingPacketMeta21 = new OutgoingPacketMeta(49, 0);
        ...
        WRITE_SOME_STRING_NONEMPTY_3619 = new OutgoingPacketMeta(53, -1);
        WRITE_SOME_SHORT_3115 = new OutgoingPacketMeta(54, 2);
        ...
        WRITE_SOME_STRING_3604 = new OutgoingPacketMeta(67, -1);
        USE_SPELL_ON_OBJECT = new OutgoingPacketMeta(68, 13);
        anOutgoingPacketMeta51 = new OutgoingPacketMeta(69, 4);
        ...
        anOutgoingPacketMeta33 = new OutgoingPacketMeta(75, 10);
        ...
        WRITE_SOME_STRING_3116 = new OutgoingPacketMeta(86, -2);
        ...
        WRITE_SOME_STRING_5002 = new OutgoingPacketMeta(92, -1);
        WRITE_SOME_STRING_5009 = new OutgoingPacketMeta(93, -2);
        ...
        WRITE_SOME_STRING_3105 = new OutgoingPacketMeta(100, -1);
    }
    ...
    public static void method4() {
        for (ObjectSound var0 = (ObjectSound) ObjectSound.aNodeDeque373.head(); var0 != null; var0 = (ObjectSound) ObjectSound.aNodeDeque373.next()) {
            if (var0.aClass5_Sub6_Sub2_370 != null) {
                WorldMapLabelSize.aClass5_Sub6_Sub1_528.method306(var0.aClass5_Sub6_Sub2_370);
                var0.aClass5_Sub6_Sub2_370 = null;
            }

            if (var0.aClass5_Sub6_Sub2_369 != null) {
                WorldMapLabelSize.aClass5_Sub6_Sub1_528.method306(var0.aClass5_Sub6_Sub2_369);
                var0.aClass5_Sub6_Sub2_369 = null;
            }
        }

        ObjectSound.aNodeDeque373.clear();
    }

    public static IndexedSprite method6(boolean var0, boolean var1) {
        return var0 ? (var1 ? Login.aDoublyNode_Sub24_Sub4_470 : WorldMapAreaChunk_Sub2.aDoublyNode_Sub24_Sub4_288) : (var1 ? ClientPreferences.aDoublyNode_Sub24_Sub4_363 : Statics11.aDoublyNode_Sub24_Sub4_1148);
    }

    public static void method5(int var0) {
        if (client.anInt900 != 0 && var0 != -1) {
            Statics51.method344(ClanMember.aArchive867, var0, 0, client.anInt900, false);
