...
public class GPI {
        ...
        if (var0 != null && var0.isDefined() && !var0.hidden) {
            ...
            if (var2 >= 0 && var2 < 104 && var3 >= 0 && var3 < 104) {
                ...
                if (var0.transformedNpcModel != null && client.engineCycle >= var0.animationStartCycle && client.engineCycle < var0.animationEndCycle) {
                    ...
                    var0.anInt379 = SceneGraph.getTileHeight(var0.absoluteX, var0.absoluteY, SceneGraph.floorLevel);
                    var0.renderCycle = client.engineCycle;
                    client.sceneGraph.addPlayerObject(SceneGraph.floorLevel, var0.absoluteX, var0.absoluteY, var0.anInt379, var0, var0.turnOrientation, var4, var0.anInt702, var0.anInt788, var0.anInt666, var0.anInt791);
                } else {
                    ...
                    var0.anInt379 = SceneGraph.getTileHeight(var0.absoluteX, var0.absoluteY, SceneGraph.floorLevel);
                    var0.renderCycle = client.engineCycle;
                    client.sceneGraph.addEntityMarker(SceneGraph.floorLevel, var0.absoluteX, var0.absoluteY, var0.anInt379, 60, var0, var0.turnOrientation, var4, var0.stretch);
                }
            }
        }
    ...
    public static void loadPlayerIntoScene() {
        if (client.anInt1030 >= 0 && client.players[client.anInt1030] != null) {
            loadPlayersIntoScene(client.players[client.anInt1030], false);
        }
