...
public class Material extends Node {
    ...
    public Material(Buffer var1) {
        this.loaded = false;
        this.rgb = var1.readUShort();
    ...
    public boolean method503(double var1, int var3, ReferenceTable var4) {
        int var5;
        ...
        for (int var6 = 0; var6 < this.anIntArray687.length; ++var6) {
            ...
            if (!var9) {
                ...
                IndexedSprite var12 = new IndexedSprite();
                var12.anInt375 = Statics41.anInt1824;
                var12.anInt372 = AnimationFrameGroup.anInt378;
                var12.insetX = Statics41.anIntArray1821[0];
                var12.insetY = PcmStream_Sub4.anIntArray1107[0];
