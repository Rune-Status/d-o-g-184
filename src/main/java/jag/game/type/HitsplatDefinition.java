...
public class HitsplatDefinition extends DoublyLinkedNode {
    ...
    public static final ReferenceCache<HitsplatDefinition> cache;
    ...
    public Font getFont() {
        ...
        font = ClanMember.method708(StockMarketOfferNameComparator.aReferenceTable480, aReferenceTable1515, fontId, 0);
        if (font != null) {
