...
public class ObjectDefinition extends DoublyLinkedNode {
    public static final ReferenceCache<ObjectDefinition> cache;
    public static final ReferenceCache<Model> models;
    public static final ReferenceCache<DoublyLinkedNode> aReferenceCache1513;
    public static final ReferenceCache<UnlitModel> rawmodels;
    ...
    static {
        aBoolean792 = false;
        cache = new ReferenceCache<>(4096);
        rawmodels = new ReferenceCache<>(500);
    ...
    public final Model method1107(int var1, int var2, int[][] var3, int var4, int var5, int var6, AnimationSequence var7, int var8) {
        long var9;
        if (modelIds == null) {
            var9 = var2 + (anInt693 << 10);
        } else {
            var9 = var2 + (var1 << 3) + (anInt693 << 10);
        }
        ...
        if (clipType >= 0) {
            var11 = var11.method1295(var3, var4, var5, var6, false, clipType);
        }
    ...
    public final Model method1103(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
        long var7;
        if (modelIds == null) {
            var7 = var2 + (anInt693 << 10);
        } else {
            var7 = var2 + (var1 << 3) + (anInt693 << 10);
        }
        ...
        if (clipType >= 0) {
            var9 = var9.method1295(var3, var4, var5, var6, true, clipType);
        }
    ...
    public final Entity method1105(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
        ...
        if (var9 == null) {
            ...
            if (!aBoolean1511) {
                ...
                var10.aShort1441 = (short) (ambient + 64);
                var10.aShort1439 = (short) (contrast * 25 + 768);
                var10.method593();
                var9 = var10;
            }
        ...
        if (clipType >= 0) {
            if (var9 instanceof Model) {
                var9 = ((Model) var9).method1295(var3, var4, var5, var6, true, clipType);
            } else if (var9 instanceof UnlitModel) {
                var9 = ((UnlitModel) var9).method977(var3, var4, var5, var6, clipType);
            }
        }
