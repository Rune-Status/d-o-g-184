...
public final class NpcEntity extends PathingEntity {
    ...
    public static void update(boolean var0, PacketBuffer buffer) {
        client.npcCount2 = 0;
        ...
        int var9;
        int var10;
        while (buffer.rem(client.netWriter.incomingPacketSize) >= 27) {
            var3 = buffer.g(15);
            if (var3 == 32767) {
                break;
            }
        ...
        for (var3 = 0; var3 < client.npcUpdateCount; ++var3) {
            ...
            if ((var6 & 8) != 0) {
                var5.graphic = buffer.method1060();
    ...
    public static void method541() {
        PacketBuffer var0 = client.netWriter.inbuffer;
        var0.bitAccess();
        int var1 = var0.g(8);
