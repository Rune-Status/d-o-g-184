...
public abstract class GameShell extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    public static final long[] engineTicks;
    ...
    void processGraphics() {
        ...
        aLongArray1289[Varcs.anInt614] = time;
    ...
    void processEngine() {
        ...
        synchronized (this) {
            OldConnectionTaskProcessor.hasFocus = aBoolean1314;
        }
            ...
            if (OldConnectionTaskProcessor.javaVendor != null) {
                ...
                if (vendor.contains("sun") || vendor.contains("apple")) {
                    ...
                    if (version.startsWith("1.6.0_")) {
                        ...
                        if (OldConnection.parseInt(minor) && BaseFont.method1501(minor) < 10) {
                            error("wrongjava");
                            return;
                        }
                    }
