...
public class StockMarketMediator {
    ...
    public static final Comparator<StockMarketEvent> aComparator610;
    public static final Comparator<StockMarketEvent> aComparator608;
    public static final Comparator<StockMarketEvent> aComparator607;
    public static final Comparator<StockMarketEvent> aComparator606;
