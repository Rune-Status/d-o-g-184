...
public final class StockMarketOfferQuantityComparator implements Comparator {
        ...
        if (RegionUpdateType.A_REGION_UPDATE_TYPE___1205 == updateType) {
            ...
            if (RegionUpdateType.REMOVE_PICKABLE == updateType) {
                ...
                if (var38 >= 0 && var4 >= 0 && var38 < 104 && var4 < 104) {
                    NodeDeque<Pickable> var32 = client.pickableNodeDeques[SceneGraph.floorLevel][var38][var4];
                    if (var32 != null) {
                        for (var33 = var32.head(); var33 != null; var33 = var32.next()) {
                ...
                if (var7 >= 0 && var8 >= 0 && var7 < 104 && var8 < 104) {
                    PendingSpawn.pushLater(SceneGraph.floorLevel, var7, var8, var5, -1, var38, var4, 0, -1);
                }
                ...
                if (RegionUpdateType.A_REGION_UPDATE_TYPE___1206 == updateType) {
                    ...
                    if (var38 >= 0 && var4 >= 0 && var38 < 104 && var4 < 104) {
                        var10 = var6 + 1;
                        if (PlayerEntity.local.pathXQueue[0] >= var38 - var10 && PlayerEntity.local.pathXQueue[0] <= var10 + var38 && PlayerEntity.local.pathYQueue[0] >= var4 - var10 && PlayerEntity.local.pathYQueue[0] <= var10 + var4 && client.anInt897 != 0 && var7 > 0 && client.audioEffectCount < 50) {
                            ...
                            client.anIntArray902[client.audioEffectCount] = var6 + (var4 << 8) + (var38 << 16);
                ...
                if (RegionUpdateType.A_REGION_UPDATE_TYPE___1204 == updateType) {
                    ...
                    if (var7 >= 0 && var8 >= 0 && var7 < 104 && var8 < 104) {
                        PendingSpawn.pushLater(SceneGraph.floorLevel, var7, var8, var5, var9, var38, var4, 0, -1);
                    }
                    ...
                    if (RegionUpdateType.SPAWN_GRAPHICS_OBJECT == updateType) {
                        ...
                        if (var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
                            var5 = var5 * 128 + 64;
                            var6 = var6 * 128 + 64;
                            EffectObject var45 = new EffectObject(var7, SceneGraph.floorLevel, var5, var6, SceneGraph.getTileHeight(var5, var6, SceneGraph.floorLevel) - var38, var37, client.engineCycle);
                    ...
                    if (var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
                        NodeDeque<Pickable> var35 = client.pickableNodeDeques[SceneGraph.floorLevel][var5][var6];
                        if (var35 != null) {
    ...
    public int compare(Object var1, Object var2) {
        return this.method478((StockMarketEvent) var1, (StockMarketEvent) var2);
    }
