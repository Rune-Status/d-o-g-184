...
public class HealthBar extends Node {
    ...
    public final LinkedList<HitUpdate> hitsplats;
    ...
    public static void method694(PathingEntity entity) {
        if (entity.forceMovementEndCycle == client.engineCycle
            ...
            int var3 = entity.boundSize + entity.anInt1354 * 128;
            int var4 = entity.boundSize + entity.anInt2011 * 128;
            int var5 = entity.boundSize + entity.anInt1351 * 128;
            int var6 = entity.boundSize + entity.anInt2016 * 128;
    ...
    public void update(int cycle, int var2, int var3, int var4) {
        ...
        if (pending == null) {
            if (var6 < 4) {
                hitsplats._add(new HitUpdate(cycle, var2, var3, var4));
            }
