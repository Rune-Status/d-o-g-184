...
public class URLRequest {
    ...
    public static Sprite[] hintIcons;
    final URL anURL778;
    ...
    public static void method617(InterfaceComponent component, ItemDefinition definition, int index, int i, boolean idk) {
        ...
        if (var6 != -1 && var7 != null) {
            client.insertMenuItem(var7, World.getColorTags(16748608) + definition.name, var6, definition.anInt693, index, component.uid, idk);
        }
    ...
    public static void loadPlayerIntoScene() {
        if (client.anInt1030 >= 0 && client.players[client.anInt1030] != null) {
            GPI.loadPlayersIntoScene(client.players[client.anInt1030], false);
        }

    }

    public static void updatePlayerLocation(PacketBuffer packet, int index) {
        ...
        if (var3 == 0) {
            if (var2) {
                ...
                GPI.playerLocations[index] = (player.anInt1473 << 28) + (client.baseX + player.pathXQueue[0] >> 13 << 14) + (client.baseY + player.pathYQueue[0] >> 13);
                if (player.transformedOrientation != -1) {
                    GPI.playerOrientations[index] = player.transformedOrientation;
                } else {
