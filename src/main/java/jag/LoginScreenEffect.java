...
public class LoginScreenEffect {
    ...
    public static Bounds aBounds_418;
    final int[] anIntArray417;
    final IndexedSprite[] aDoublyNode_Sub24_Sub4Array424;
    int anInt422;
    int[] anIntArray423;
    int[] anIntArray414;
    int[] anIntArray411;
    ...
    public LoginScreenEffect(IndexedSprite[] var1) {
    ...
    public static void method274(InterfaceComponent var0, int var1, int var2, int var3) {
    ...
    final void method275(int var1) {
        ...
        for (int var3 = 1; var3 < 255; ++var3) {
            ...
            if (var5 + 128 >= WorldMapAreaChunk_Sub2.aGraphicsProvider_284.anInt1817) {
                var7 = WorldMapAreaChunk_Sub2.aGraphicsProvider_284.anInt1817 - var5;
            }

            int var8 = var5 + (var3 + 8) * WorldMapAreaChunk_Sub2.aGraphicsProvider_284.anInt1817;
            var2 += var6;
            ...
            for (int var9 = var6; var9 < var7; ++var9) {
                ...
                if (var10 != 0 && var11 >= JagGraphics.drawingAreaLeft && var11 < JagGraphics.drawingAreaBottom) {
                    ...
                    int var14 = WorldMapAreaChunk_Sub2.aGraphicsProvider_284.anIntArray1818[var8];
                    WorldMapAreaChunk_Sub2.aGraphicsProvider_284.anIntArray1818[var8++] = -16777216 | ((var14 & 16711935) * var13 + (var10 & 16711935) * var12 & -16711936) + (var12 * (var10 & 65280) + var13 * (var14 & 65280) & 16711680) >> 8;
                } else {
                    ++var8;
                }
            }
