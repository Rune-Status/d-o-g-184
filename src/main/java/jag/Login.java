...
public class Login {
    ...
    public static void loadPlayersIntoScene() {
        ...
        for (int i = 0; i < count; ++i) {
            if (indices[i] != client.anInt1030 && indices[i] != client.playerIndex) {
    ...
    public static void draw(Font var0, Font var1, Font var2) {
        ...
        if (worldSelectorOpen) {
            ...
            if (ClientLocale.aDoublyNode_Sub24_Sub4Array1178 == null) {
                ClientLocale.aDoublyNode_Sub24_Sub4Array1178 = IndexedSprite.method474(Archive.sprites, "sl_flags", "");
            }
            ...
            if (LoadedArchive.aSpriteArray429 != null) {
                ...
                for (var27 = var36 * var26; var27 < Server.count && var26 - anInt460 < var39; ++var27) {
                    ...
                    if (ClientLocale.aDoublyNode_Sub24_Sub4Array1178 != null) {
                        ClientLocale.aDoublyNode_Sub24_Sub4Array1178[(var30.isMembers() ? 8 : 0) + var30.location].renderAt(var24 + 29, var12);
                    }
            ...
            if (client.gameState == 0 || client.gameState == 5) {
                ...
                var0.method1154(aString475, credentialsBoxX + 180, 276 - var7, 16777215, -1);
            }
            ...
            if (client.gameState == 10 || client.gameState == 11) {
                ...
                if (step == 0) {
                    ...
                    var0.method1154(aString471, credentialsBoxX + 180, 201, 16776960, 0);
                    var40 = 236;
                    ...
                    IndexedSprite var34 = OutgoingPacketMeta.method6(client.rememberUsername, aBoolean477);
                    ...
                    LoginScreenEffect.aBounds_418 = new Bounds(credentialsBoxCenterX, var40, var1.textWidth(SerializableProcessor.aString636), 11);
                    LoginPacketMeta.aBounds_846 = new Bounds(credentialsBoxCenterX, var40, var1.textWidth("Still having trouble logging in?"), 11);
    ...
    public static void processLoadingScreen() {
        ...
        if (client.bootState == 0) {
            ...
            if (var0 != 100) {
                ...
                WorldMapTileDecor_Sub2.aBootSprites_647.method1190(Archive.bootSprites);
            ...
            if (client.bootState == 45) {
                ...
                if (client.fonts.size() < var0) {
                    ...
                    Statics7.fontb12full = (Font) client.fonts.get(NamedFont.B12);
                ...
                if (client.bootState == 60) {
                    ...
                    if (!Archive.config.method908()) {
                        aString475 = "Loading config - " + Archive.config.method489() + "%";
                        anInt473 = 60;
                    } else {
                        ...
                        ItemDefinition.method240(Archive.config, Archive.models, client.membersWorld, StockMarketOfferWorldComparator.aFont345);
                        ...
                        VarDefinition.anInt568 = VarDefinition.table.getFileCount(16);
                        ...
                        VarcInteger.aReferenceTable383 = Archive.config;
                        DefinitionProperty.table = Archive.config;
                    ...
                    if (AttackOptionPriority.compass == null) {
                        AttackOptionPriority.compass = Sprite.get(Archive.sprites, WorldMapTileDecor_Sub2.aBootSprites_647.anInt1656, 0);
                    } else {
                        ++var0;
                    }
                    ...
                    if (Statics52.mapscene == null) {
                        Statics52.mapscene = Statics38.method1194(Archive.sprites, WorldMapTileDecor_Sub2.aBootSprites_647.anInt1653, 0);
                    } else {
                        ++var0;
                    }

                    if (ParameterDefinition.prayerIconSprites == null) {
                        ParameterDefinition.prayerIconSprites = Canvas.method643(Archive.sprites, WorldMapTileDecor_Sub2.aBootSprites_647.anInt1652, 0);
                    } else {
                        ++var0;
                    }

                    if (WorldMapChunkDefinition.skullIconSprites == null) {
                        WorldMapChunkDefinition.skullIconSprites = Canvas.method643(Archive.sprites, WorldMapTileDecor_Sub2.aBootSprites_647.anInt1650, 0);
                    } else {
                        ++var0;
                    }
                    ...
                    if (!Archive.interfaces.method908()) {
                        aString475 = "Loading interfaces - " + Archive.interfaces.method489() * 4 / 5 + "%";
                        anInt473 = 96;
                    } else if (!Archive.cs2.method908()) {
                        aString475 = "Loading interfaces - " + (80 + Archive.cs2.method489() / 6) + "%";
                        anInt473 = 96;
                    } else if (!Archive.fonts.method908()) {
                        aString475 = "Loading interfaces - " + (96 + Archive.fonts.method489() / 50) + "%";
                        anInt473 = 96;
                    } else {
                    ...
                    if (!Archive.worldmap.method909(WorldMapCacheFeature.DETAILS.name)) {
                        aString475 = "Loading world map - " + Archive.worldmap.method895(WorldMapCacheFeature.DETAILS.name) / 10 + "%";
                    } else {
                        if (client.worldMap == null) {
                            client.worldMap = new WorldMap();
                            client.worldMap.initialize(Archive.worldmap, Archive.mapscene, Archive.mapland, Statics7.fontb12full, client.fonts, Statics52.mapscene);
                        }
                ...
                if (client.gameState == 10 || client.gameState == 11) {
                    if (WorldMapLabelSize.aClientLocale_525 == ClientLocale.GB) {
                        if (Mouse.clickMeta == 1 || !WorldMapObjectIcon.mouseCameraEnabled && Mouse.clickMeta == 4) {
                            ...
                            if (Mouse.clickX >= var6 && Mouse.clickX <= var9 + var6 && Mouse.clickY >= var8 && Mouse.clickY <= var8 + var10) {
                                if (AsyncConnection.loadServers()) {
                        ...
                        if (Server.request != null && AsyncConnection.loadServers()) {
                            worldSelectorOpen = true;
                            anInt460 = 0;
                            anInt466 = 0;
                        }
                    ...
                    if (step == 0) {
                        ...
                        if (var6 == 1 && var18 >= var11 - 75 && var18 <= var11 + 75 && var19 >= var12 - 20 && var19 <= var12 + 20) {
                            CacheRequestWorker.openURL(GameShell.method611("secure", true) + "m=account-creation/g=oldscape/create_account_funnel.ws", true, false);
                        }
                        ...
                        if (step != 1) {
                            ...
                            if (step == 2) {
                                ...
                                if (LoginScreenEffect.aBounds_418 != null) {
                                    var11 = LoginScreenEffect.aBounds_418.width / 2;
                                    if (var6 == 1 && var18 >= LoginScreenEffect.aBounds_418.x - var11 && var18 <= var11 + LoginScreenEffect.aBounds_418.x && var19 >= var22 - 15 && var19 < var22) {
                                        switch (anInt469) {
                                            case 1:
                                                ...
                                                return;
                                            case 2:
                                                CacheRequestWorker.openURL("https://support.runescape.com/hc/en-gb", true, false);
                                        }
                                    }
                                }
                            ...
                            if (step == 3) {
                                ...
                                if (step == 4) {
                                    ...
                                    if (var6 == 1 && var18 >= var21 - 75 && var18 <= var21 + 75 && var19 >= var23 - 20 && var19 <= var23 + 20) {
                                        ...
                                        RegionUpdateType.parsedTotp = Integer.parseInt(totp);
                                        totp = "";
                                    ...
                                    if (var6 == 1 && var18 >= credentialsBoxX + 180 - 34 && var18 <= credentialsBoxX + 34 + 180 && var19 >= 351 && var19 <= 363) {
                                        CacheRequestWorker.openURL(GameShell.method611("secure", true) + "m=totp-authenticator/disableTOTPRequest", true, false);
                                    }
                                    ...
                                    var12 = 361;
                                    if (LoginPacketMeta.aBounds_846 != null) {
                                        var25 = LoginPacketMeta.aBounds_846.width / 2;
                                        if (var6 == 1 && var18 >= LoginPacketMeta.aBounds_846.x - var25 && var18 <= var25 + LoginPacketMeta.aBounds_846.x && var19 >= var12 - 15 && var19 < var12) {
                                            CacheRequestWorker.openURL(GameShell.method611("secure", true) + "m=weblogin/g=oldscape/cant_log_in", true, false);
                                        }
                                    }
                                    ...
                                    var23 = 321;
                                    if (var6 == 1 && var18 >= var21 - 75 && var18 <= var21 + 75 && var19 >= var23 - 20 && var19 <= var23 + 20) {
                                        CacheRequestWorker.openURL(GameShell.method611("secure", true) + "m=dob/set_dob.ws", true, false);
                                    ...
                                    var23 = 321;
                                    if (var6 == 1 && var18 >= var21 - 75 && var18 <= var21 + 75 && var19 >= var23 - 20 && var19 <= var23 + 20) {
                                        CacheRequestWorker.openURL("https://www.jagex.com/terms/privacy/#eight", true, false);
                                        setMessages("", "Page has opened in a new window.", "(Please check your popup blocker.)");
                                        step = 6;
                                        return;
                                    }
                                    ...
                                    var12 = 276;
                                    if (var6 == 1 && var18 >= var11 - 75 && var18 <= var11 + 75 && var19 >= var12 - 20 && var19 <= var12 + 20) {
                                        CacheRequestWorker.openURL(var16, true, false);
                                        setMessages("", "Page has opened in a new window.", "(Please check your popup blocker.)");
                                        step = 6;
                                        return;
                                    }
    ...
    public static void prepare(ReferenceTable var0, ReferenceTable var1, boolean var2, int step) {
        if (clear) {
            ...
            Statics11.aDoublyNode_Sub24_Sub4_1148 = WorldMapArea.loadIndexedSprite(var1, "options_radio_buttons,0", "");
