...
public final class Bzip2Decompressor {
    ...
    public static final Bzip2Entry entry;

    static {
        entry = new Bzip2Entry();
    }
    ...
    public static void processEntry(Bzip2Entry entry) {
        ...
        if (DirectByteBufferProvider.anIntArray1138 == null) {
            DirectByteBufferProvider.anIntArray1138 = new int[100000];
        }
        ...
        while (true) {
            while (var23) {
                ...
                entry.anInt1611 = 0;
                var24 = readUByte(entry);
                entry.anInt1611 = entry.anInt1611 << 8 | var24 & 255;
                var24 = readUByte(entry);
                entry.anInt1611 = entry.anInt1611 << 8 | var24 & 255;
                var24 = readUByte(entry);
                entry.anInt1611 = entry.anInt1611 << 8 | var24 & 255;
                ...
                for (var30 = 15; var30 >= 0; --var30) {
                    for (var56 = 15; var56 >= 0; --var56) {
                        entry.aByteArray1576[var55] = (byte) (var56 + var30 * 16);
                        --var55;
                    }
                ...
                while (true) {
                    ...
                    while (var46 != var42) {
                        if (var46 != 0 && var46 != 1) {
                            ...
                            if (var31 < 16) {
                                ...
                                for (var24 = entry.aByteArray1576[var32 + var31]; var31 > 3; var31 -= 4) {
                                    int var33 = var32 + var31;
                                    entry.aByteArray1576[var33] = entry.aByteArray1576[var33 - 1];
                                    entry.aByteArray1576[var33 - 1] = entry.aByteArray1576[var33 - 2];
                                    entry.aByteArray1576[var33 - 2] = entry.aByteArray1576[var33 - 3];
                                    entry.aByteArray1576[var33 - 3] = entry.aByteArray1576[var33 - 4];
                                }

                                while (var31 > 0) {
                                    entry.aByteArray1576[var32 + var31] = entry.aByteArray1576[var32 + var31 - 1];
                                    --var31;
                                }

                                entry.aByteArray1576[var32] = var24;
                            } else {
                                int var34 = var31 / 16;
                                int var35 = var31 % 16;
                                var32 = entry.anIntArray1597[var34] + var35;

                                for (var24 = entry.aByteArray1576[var32]; var32 > entry.anIntArray1597[var34]; --var32) {
                                    entry.aByteArray1576[var32] = entry.aByteArray1576[var32 - 1];
                                }

                                for (; var34 > 0; --var34) {
                                    entry.aByteArray1576[entry.anIntArray1597[var34]] = entry.aByteArray1576[entry.anIntArray1597[var34 - 1] + 16 - 1];
                                }

                                entry.aByteArray1576[entry.anIntArray1597[0]] = var24;
                                if (entry.anIntArray1597[0] == 0) {
                                    var55 = 4095;

                                    for (var30 = 15; var30 >= 0; --var30) {
                                        for (var56 = 15; var56 >= 0; --var56) {
                                            entry.aByteArray1576[var55] = entry.aByteArray1576[entry.anIntArray1597[var30] + var56];
                                            --var55;
                                        }
                            ...
                            DirectByteBufferProvider.anIntArray1138[var47] = entry.unseq[var24 & 255] & 255;
                            ++var47;
                            if (var45 == 0) {
                                ++var43;
                                var45 = 50;
                            ...
                            ++var48;
                            var24 = entry.unseq[entry.aByteArray1576[entry.anIntArray1597[0]] & 255];
                            var10000 = entry.anIntArray1586;

                            for (var10000[var24 & 255] += var48; var48 > 0; --var48) {
                                DirectByteBufferProvider.anIntArray1138[var47] = var24 & 255;
                                ++var47;
                            }
                        }
                    }
                    ...
                    entry.anInt1585 = 0;
                    entry.aByte1578 = 0;
                    entry.anIntArray1584[0] = 0;

                    for (int var36 = 1; var36 <= 256; ++var36) {
                        entry.anIntArray1584[var36] = entry.anIntArray1586[var36 - 1];
                    }

                    for (int var36 = 1; var36 <= 256; ++var36) {
                        var10000 = entry.anIntArray1584;
                        var10000[var36] += entry.anIntArray1584[var36 - 1];
                    }

                    for (int var36 = 0; var36 < var47; ++var36) {
                        var24 = (byte) (DirectByteBufferProvider.anIntArray1138[var36] & 255);
                        var10000 = DirectByteBufferProvider.anIntArray1138;
                        int var10001 = entry.anIntArray1584[var24 & 255];
                        var10000[var10001] |= var36 << 8;
                    }

                    entry.anInt1588 = DirectByteBufferProvider.anIntArray1138[entry.anInt1611] >> 8;
                    entry.anInt1590 = 0;
                    entry.anInt1588 = DirectByteBufferProvider.anIntArray1138[entry.anInt1588];
    ...
    static int readBits(int var0, Bzip2Entry var1) {
        while (var1.anInt1605 < var0) {
            var1.anInt1610 = var1.anInt1610 << 8 | var1.inputBuffer[var1.caret] & 255;
            var1.anInt1605 += 8;
            ++var1.caret;
            ++var1.anInt1613;
        }
    ...
    static void method1180(Bzip2Entry var0) {
        ...
        int[] var5 = DirectByteBufferProvider.anIntArray1138;
        ...
        var0.anInt1590 = var3;
        var0.anInt1604 = var4;
        DirectByteBufferProvider.anIntArray1138 = var5;
        var0.anInt1588 = var6;
