...
public class AssociateComparator_Sub2 extends AssociateComparator {
    static DoublyLinkedNode_Sub24_Sub4[] aDoublyNode_Sub24_Sub4Array765;
    static Class202 aClass202_766;
    ...
    static int method606(World var0, World var1, int var2, boolean var3) {
        if (var2 == 1) {
