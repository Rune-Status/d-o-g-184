...
public class IgnoreListContext extends ChatterContext {
    ...
    public IgnoreListContext(Class213 var1) {
        super(400);
    ...
    public void method338(Buffer var1, int var2) {
        while (true) {
            if (var1.caret < var2) {
                ...
                NamePair var5 = new NamePair(var1.readString(), this.aClass213_486);
                NamePair var6 = new NamePair(var1.readString(), this.aClass213_486);
                var1.readString();
