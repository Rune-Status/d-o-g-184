...
public class FriendListContext extends ChatterContext {
    final Class213 aClass213_486;
    public LinkableDeque loginUpdates;
    int anInt833;

    public FriendListContext(Class213 var1) {
        super(400);
        this.anInt833 = 1;
        this.loginUpdates = new LinkableDeque();
        this.aClass213_486 = var1;
    }
    ...
    public void decode(Buffer buffer, int available) {
        while (true) {
            if (buffer.caret < available) {
                ...
                NamePair displayName = new NamePair(buffer.readString(), this.aClass213_486);
                NamePair previousName = new NamePair(buffer.readString(), this.aClass213_486);
                ...
                if (displayName.isFormattedPresent()) {
                    ...
                    if (var6 != var11.world) {
                        var11.anInt1222 = ++this.anInt833 - 1;
                        if (var11.world == -1 && var6 == 0) {
                            var11.anInt1222 = -(var11.anInt1222);
                        }
