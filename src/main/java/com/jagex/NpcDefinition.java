...
public class NpcDefinition extends DoublyLinkedNode {
    ...
    public static ReferenceCache modelCache;
    ...
    static void method505(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
        int var7 = var6 - 334;
        if (var7 < 0) {
            var7 = 0;
        } else if (var7 > 100) {
        ...
        Class38.cameraX = var0 - var10;
        Class79.cameraZ = var1 - var11;
        Class27_Sub1.cameraY = var2 - var12;
        IgnoreListContext.cameraPitch = var3;
        Class70.cameraYaw = var4;
        if (client.anInt988 == 1 && client.rights >= 2 && client.engineCycle % 50 == 0 && (Node_Sub2.anInt371 >> 7 != PlayerEntity.local.fineX >> 7 || Class62.anInt498 >> 7 != PlayerEntity.local.fineY >> 7)) {
            var13 = PlayerEntity.local.anInt1473;
            var14 = Statics18.baseX + (Node_Sub2.anInt371 >> 7);
            var15 = Statics36.baseY + (Class62.anInt498 >> 7);
    ...
    public final NpcDefinition transform() {
        ...
        return var2 != -1 ? OutgoingPacket.getNpcDefinition(var2) : null;
    }
    ...
    void decodeOpcode(Buffer buffer, int opcode) {
        ...
        if (opcode == 1) {
            ...
            if (opcode == 107) {
                ...
                this.properties = AssociateComparator_Sub5.method676(buffer, this.properties);
            }
        } else {
    ...
    public final Model getModel(AnimationSequence anim, int animFrame, AnimationSequence stance, int stanceFrame) {
        ...
        Model staticModel = (Model) modelCache.get((long) this.id);
        if (staticModel == null) {
            boolean var6 = false;
            ...
            modelCache.put(staticModel, (long) this.id);
        }
