...
public final class Font extends DoublyLinkedNode_Sub24_Sub3 {
    ...
    final void method272(byte[] var1, int var2, int var3, int var4, int var5, int var6) {
        ...
        if (var4 > 0 && var5 > 0) {
            DoublyLinkedNode_Sub24_Sub3.method1156(JagGraphics.drawingAreaPixels, var1, var6, var10, var7, var4, var5, var8, var9);
        }
    }

    final void method273(byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
        ...
        if (var4 > 0 && var5 > 0) {
            DoublyLinkedNode_Sub24_Sub3.method1158(JagGraphics.drawingAreaPixels, var1, var6, var11, var8, var4, var5, var9, var10, var7);
        }
    }
}
