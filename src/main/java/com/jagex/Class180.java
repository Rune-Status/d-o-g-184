...
public class Class180 {
    ...
    public void method1119() {
        if (this.gameStateChangeTime != -1L) {
            this.aLong1524 = Class24.currentTime() - this.gameStateChangeTime;
            this.gameStateChangeTime = -1L;
        }
    ...
    public void dropConnection() {
        if (this.aLong1528 != -1L) {
            this.aLong1523 = Class24.currentTime() - this.aLong1528;
            this.aLong1528 = -1L;
        }
    ...
    public void updateGameState(int gameState) {
        this.gameStateChangeTime = Class24.currentTime();
        this.gameState = gameState;
    }

    public void updateTime() {
        this.aLong1528 = Class24.currentTime();
    }
