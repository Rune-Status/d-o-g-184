...
public class UnlitModel extends Entity {
    ...
    static int[] anIntArray1434;
    static int[] anIntArray1427;
    static int[] anIntArray1430;
    ...
    boolean aBoolean1420;
    int[] anIntArray787;
    Class96[] aClass96Array1431;
    int[] xVertices;
    ...
    byte[] aByteArray1440;
    int[] zVertices;
    short[] aShortArray1435;
    Class96[] aClass96Array1422;
    int anInt556;
    int anInt1105;
    Class104[] aClass104Array1432;
    int[] anIntArray747;
    int[][] anIntArrayArray1429;
    int anInt1437;
    byte defaultRenderPriority;
    int[][] anIntArrayArray1426;
    int[] anIntArray692;
    int anInt579;
    int anInt702;
    int[] anIntArray687;
    ...
    static void method970(UnlitModel var0, UnlitModel var1, int var2, int var3, int var4, boolean var5) {
        var0.method973();
        var0.method593();
        var1.method973();
        var1.method593();
        ...
        for (var9 = 0; var9 < var0.anInt380; ++var9) {
            Class96 var10 = var0.aClass96Array1431[var9];
            if (var10.anInt728 != 0) {
                    ...
                    if (var12 >= var1.anInt1436 && var12 <= var1.anInt556) {
                        ...
                        if (var13 >= var1.anInt1437 && var13 <= var1.anInt579) {
                            for (int var14 = 0; var14 < var8; ++var14) {
                                Class96 var15 = var1.aClass96Array1431[var14];
                                if (var12 == var7[var14] && var13 == var1.zVertices[var14] && var11 == var1.yVertices[var14] && var15.anInt728 != 0) {
                                    if (var0.aClass96Array1422 == null) {
                                        var0.aClass96Array1422 = new Class96[var0.anInt380];
                                    }

                                    if (var1.aClass96Array1422 == null) {
                                        var1.aClass96Array1422 = new Class96[var8];
                                    }

                                    Class96 var16 = var0.aClass96Array1422[var9];
                                    if (var16 == null) {
                                        var16 = var0.aClass96Array1422[var9] = new Class96(var10);
                                    }

                                    Class96 var17 = var1.aClass96Array1422[var14];
                                    if (var17 == null) {
                                        var17 = var1.aClass96Array1422[var14] = new Class96(var15);
                                    }
    ...
    static int method974(int var0, int var1) {
    ...
    public void method593() {
        if (this.aClass96Array1431 == null) {
            this.aClass96Array1431 = new Class96[this.anInt380];

            int var1;
            for (var1 = 0; var1 < this.anInt380; ++var1) {
                this.aClass96Array1431[var1] = new Class96();
            }
            ...
            for (var1 = 0; var1 < this.anInt574; ++var1) {
                ...
                if (var15 == 0) {
                    Class96 var16 = this.aClass96Array1431[var2];
                    ...
                    if (this.aClass104Array1432 == null) {
                        this.aClass104Array1432 = new Class104[this.anInt574];
                    }

                    Class104 var17 = this.aClass104Array1432[var1] = new Class104();
    ...
    final int method979(UnlitModel var1, int var2) {
        int var3 = -1;
