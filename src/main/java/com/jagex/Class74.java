...
final class Class74 implements Comparator {
    static CacheReferenceTable sprites;
    static boolean aBoolean584;
    static CacheReferenceTable aCacheReferenceTable586;
    static InterfaceComponent anInterfaceComponent585;
    ...
    static void method411() {
        ...
        if (Class55.username.length() == 0) {
            ...
            long var6;
            try {
                URL var0 = new URL(Class104.method611("services", false) + "m=accountappeal/login.ws");
            ...
            if (0L == var6) {
                ...
                var13.writeRSA(Class82.aBigInteger628, Class82.aBigInteger626);
                var14.writeByte(10);
                ...
                var14.writeLong(var48.nextLong());
                var14.writeRSA(Class82.aBigInteger628, Class82.aBigInteger626);
                var16 = Statics30.stringLengthPlusOne(var47);
                if (var16 % 8 != 0) {
                    var16 += 8 - var16 % 8;
                }
                ...
                byte var43;
                try {
                    URL var25 = new URL(Class104.method611("services", false) + "m=accountappeal/login.ws");
                    ...
                    for (var34 = 0; var34 < var51; ++var34) {
                        ...
                        if ((var38 < 'a' || var38 > 'z') && (var38 < 'A' || var38 > 'Z') && (var38 < '0' || var38 > '9') && var38 != '.' && var38 != '-' && var38 != '*' && var38 != '_') {
                            if (var38 == ' ') {
                                ...
                                byte var39 = Entity.method10(var38);
                                var37.append('%');
                    ...
                    while (true) {
                        ...
                        if (var52 == -1) {
                            ...
                            if (var53.startsWith("OFFLINE")) {
                                ...
                                if (Class45.method286(var53)) {
                                    Class174.method1006(var53, true, false);
                                    var43 = 2;
                                } else {
                                    var43 = 5;
                                }
            ...
            switch (var12) {
                case 2:
                    Enum_Sub6.setLoginMessages(Statics24.aString1416, Statics24.aString1418, Statics24.aString1415);
                ...
                case 3:
                    ...
                    break;
                case 4:
                    Enum_Sub6.setLoginMessages("The part of the website you are trying", "to connect to is offline at the moment.", "Please try again later.");
                    break;
                case 5:
                    Enum_Sub6.setLoginMessages("Sorry, there was an error trying to", "log you in to this part of the website.", "Please try again later.");
                    break;
                case 6:
                    Enum_Sub6.setLoginMessages("", "Error connecting to server.", "");
                    break;
                case 7:
                    Enum_Sub6.setLoginMessages("You must enter a valid login to proceed. For accounts", "created after 24th November 2010, please use your", "email address. Otherwise please use your username.");
            }

        }
    }

    static void method414(int var0, int var1, int var2, int var3, int var4, int var5, SceneGraph var6, CollisionMap var7) {
        if (!client.lowMemory || (Class44.sceneRenderRules[0][var1][var2] & 2) != 0 || (Class44.sceneRenderRules[var0][var1][var2] & 16) == 0) {
            if (var0 < Class44.anInt405) {
                Class44.anInt405 = var0;
            }

            ObjectDefinition var8 = Class38.getObjectDefinition(var3);
            int var9;
            int var10;
            if (var4 != 1 && var4 != 3) {
                var9 = var8.sizeX;
            ...
            int[][] var15 = Class44.tileHeights[var0];
            ...
            if (var8.method1099()) {
                ...
                Node_Sub2.aNodeDeque373.add(var22);
            ...
            if (var5 == 22) {
                ...
                if (var5 >= 12) {
                    ...
                    if (var5 >= 12 && var5 <= 17 && var5 != 13 && var0 > 0) {
                        var10000 = Class44.anIntArrayArrayArray393[var0][var1];
                        var10000[var2] |= 2340;
                    }

                    if (var8.anInt791 != 0 && var7 != null) {
                        var7.method160(var1, var2, var9, var10, var8.impenetrable);
                    }
                    ...
                    var6.addBoundary(var0, var1, var2, var16, var34, null, Class44.anIntArray406[var4], 0, var19, var21);
                    if (var4 == 0) {
                        if (var8.clipped) {
                            Class44.aByteArrayArrayArray400[var0][var1][var2] = 50;
                            Class44.aByteArrayArrayArray400[var0][var1][var2 + 1] = 50;
                        }
                        ...
                        if (var8.clipped) {
                            Class44.aByteArrayArrayArray400[var0][var1][var2 + 1] = 50;
                            Class44.aByteArrayArrayArray400[var0][var1 + 1][var2 + 1] = 50;
                        }
                        ...
                        if (var8.clipped) {
                            Class44.aByteArrayArrayArray400[var0][var1 + 1][var2] = 50;
                            Class44.aByteArrayArrayArray400[var0][var1 + 1][var2 + 1] = 50;
                        }

                        if (var8.projectileClipped) {
                            var10000 = Class44.anIntArrayArrayArray393[var0][var1 + 1];
                            var10000[var2] |= 585;
                        }
                    } else if (var4 == 3) {
                        if (var8.clipped) {
                    ...
                    var6.addBoundary(var0, var1, var2, var16, var34, null, Class44.anIntArray395[var4], 0, var19, var21);
                    if (var8.clipped) {
                        if (var4 == 0) {
                            Class44.aByteArrayArrayArray400[var0][var1][var2 + 1] = 50;
                        } else if (var4 == 1) {
                    ...
                    if (var5 == 2) {
                        ...
                        var6.addBoundary(var0, var1, var2, var16, var27, var28, Class44.anIntArray406[var4], Class44.anIntArray406[var26], var19, var21);
                        if (var8.projectileClipped) {
                            if (var4 == 0) {
                                var10000 = Class44.anIntArrayArrayArray393[var0][var1];
                                var10000[var2] |= 585;
                        ...
                        var6.addBoundaryDecor(var0, var1, var2, var16, var34, null, Class44.anIntArray406[var4], 0, 0, 0, var19, var21);
                    } else {
                        long var29;
                        Entity var31;
                        if (var5 == 5) {
                            ...
                            if (0L != var29) {
                                var26 = Class38.getObjectDefinition(EntityUID.getObjectId(var29)).anInt1369;
                            }
                            ...
                            var6.addBoundaryDecor(var0, var1, var2, var16, var31, null, Class44.anIntArray406[var4], 0, var26 * Class44.anIntArray402[var4], var26 * Class44.anIntArray394[var4], var19, var21);
                        } else if (var5 == 6) {
                            var26 = 8;
                            var29 = var6.method1456(var0, var1, var2);
                            if (0L != var29) {
                                var26 = Class38.getObjectDefinition(EntityUID.getObjectId(var29)).anInt1369 / 2;
                            }
                            ...
                            var6.addBoundaryDecor(var0, var1, var2, var16, var31, null, 256, var4, var26 * Class44.anIntArray397[var4], var26 * Class44.anIntArray392[var4], var19, var21);
                        } else if (var5 == 7) {
                            var23 = var4 + 2 & 3;
                            if (var8.animation == -1 && var8.transformIds == null) {
                            ...
                            var6.addBoundaryDecor(var0, var1, var2, var16, var31, var33, 256, var4, var26 * Class44.anIntArray397[var4], var26 * Class44.anIntArray392[var4], var19, var21);
                        }
                    }
                }
            } else {
                ...
                if (var34 != null && var6.method1470(var0, var1, var2, var16, var9, var10, var34, var5 == 11 ? 256 : 0, var19, var21) && var8.clipped) {
                    ...
                    for (var24 = 0; var24 <= var9; ++var24) {
                        for (int var25 = 0; var25 <= var10; ++var25) {
                            if (var23 > Class44.aByteArrayArrayArray400[var0][var24 + var1][var25 + var2]) {
                                Class44.aByteArrayArrayArray400[var0][var24 + var1][var25 + var2] = (byte) var23;
                            }
                        }
                    }
                }
    ...
    static int method412(int var0, int var1, int var2) {
        if (var2 > 179) {
            var1 /= 2;
        }
    ...
    int method413(Class72 var1, Class72 var2) {
        return Long.compare(var1.aLong553, var2.aLong553);
    }
    ...
    public int compare(Object var1, Object var2) {
        return this.method413((Class72) var1, (Class72) var2);
    }
}
