...
public class Statics2 {
    ...
    static void method481(int var0, int var1, int var2, int var3) {
        client.anInt1000 = 0;
        boolean var4 = false;
        int var5 = -1;
        int var6 = -1;
        ...
        for (var9 = 0; var9 < var7 + client.npcCount; ++var9) {
            ...
            Enum_Sub10.method1297(var10, var9, var0, var1, var2, var3);
        }

        if (client.aBoolean1020 && var6 != -1) {
            Enum_Sub10.method1297(PlayerEntity.local, var6, var0, var1, var2, var3);
        }

        if (var4) {
            Enum_Sub10.method1297(client.players[client.anInt1030], var5, var0, var1, var2, var3);
        }
        ...
        for (var9 = 0; var9 < client.anInt1000; ++var9) {
            ...
            String var17 = client.aStringArray1011[var9];
            if (client.anInt1045 == 0) {
                ...
                if (client.anIntArray1007[var9] == 4) {
                    ...
                    Statics7.aFont863.method1152(var17, var0 + client.anInt998 + 50 - var19, client.anInt993 + var1, var18, 0);
