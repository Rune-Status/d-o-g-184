...
public class AudioTrack extends Node {
            ...
            while (true) {
                while (true) {
                    ...
                    if (var64 == 7) {
                        ...
                        var51.writeByte(47);
                        var51.writeByte(0);
                        var51.method1032(var51.caret - var61);
                        continue label221;
                    }
    ...
    public static AudioTrack loadAudioTrack(ReferenceTable var0, int var1, int var2) {
    ...
    void method254() {
        if (this.aNodeTable1112 == null) {
            ...
            var2[9] = 128;
            var1[9] = 128;
            Class137 var4 = new Class137(this.aByteArray503);
                    ...
                    while (var7 == var4.anIntArray1115[var6]) {
                        ...
                        if (var9 == 144) {
                            ...
                            if (var12 > 0) {
                                ...
                                Node_Sub14 var14 = (Node_Sub14) this.aNodeTable1112.lookup((long) var13);
                                if (var14 == null) {
                                    var14 = new Node_Sub14(new byte[128]);
                                    this.aNodeTable1112.put(var14, (long) var13);
                                }

                                var14.aByteArray847[var11] = 1;
                            }
                        }
