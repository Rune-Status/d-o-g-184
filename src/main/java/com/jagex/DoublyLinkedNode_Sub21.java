...
public class DoublyLinkedNode_Sub21 extends DoublyLinkedNode {
    public static ReferenceCache aReferenceCache700;
    public static ReferenceTable aReferenceTable383;
    static InterfaceComponent anInterfaceComponent1518;
    ...
    public boolean method882() {
        ...
        for (int var2 = 0; var2 < 5; ++var2) {
            if (this.anIntArray1101[var2] != -1 && !Class38.aReferenceTable350.method913(this.anIntArray1101[var2], 0)) {
                var1 = false;
            }
        }
    ...
    public UnlitModel method1113() {
        ...
        for (int var3 = 0; var3 < 5; ++var3) {
            if (this.anIntArray1101[var3] != -1) {
                var1[var2++] = UnlitModel.method982(Class38.aReferenceTable350, this.anIntArray1101[var3], 0);
            }
        }
    ...
    public boolean method1114() {
        ...
        for (int anAnIntArray747 : this.anIntArray747) {
            if (!Class38.aReferenceTable350.method913(anAnIntArray747, 0)) {
                var1 = false;
            }
        }
    ...
    public UnlitModel method978() {
        ...
        for (int var2 = 0; var2 < this.anIntArray747.length; ++var2) {
            var1[var2] = UnlitModel.method982(Class38.aReferenceTable350, this.anIntArray747[var2], 0);
        }
