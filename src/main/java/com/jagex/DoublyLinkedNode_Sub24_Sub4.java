...
public final class DoublyLinkedNode_Sub24_Sub4 extends JagGraphics {
    ...
    public void method1324(int var1, int var2) {
        ...
        if (var6 > 0 && var5 > 0) {
            method1323(JagGraphics.drawingAreaPixels, this.indices, this.palette, var4, var3, var6, var5, var7, var8);
        }
    }
    ...
    public void method1322(int var1, int var2, int var3, int var4) {
        ...
        method1321(JagGraphics.drawingAreaPixels, this.indices, this.palette, var7, var8, var13, var14, var3, var4, var11, var12, var5);
    }
