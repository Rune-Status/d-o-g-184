...
public class Node_Sub6_Sub3 extends Node_Sub6 {
    int anInt694;
    int anInt568;
    int[] anIntArray781;
    int[] anIntArray690;
    NodeTable aNodeTable1112;
    int[] anIntArray1107;
    int[] anIntArray692;
    int[] anIntArray687;
    Node_Sub19[][] aNode_Sub19ArrayArray1104;
    int[] anIntArray1102;
    Class137 aClass137_1111;
    Node_Sub6_Sub4 aClass5_Sub6_Sub4_1110;
    int[] anIntArray1108;
    int anInt1105;
    int[] anIntArray785;
    int[] anIntArray691;
    ...
    Node_Sub19[][] aNode_Sub19ArrayArray1099;
    int[] anIntArray1100;
    long aLong1106;
    int[] anIntArray1101;
    int[] anIntArray787;

    public Node_Sub6_Sub3() {
        this.anInt568 = 256;
        ...
        this.aClass137_1111 = new Class137();
        this.aClass5_Sub6_Sub4_1110 = new Node_Sub6_Sub4(this);
        ...
        for (Node_Sub19 var2 = (Node_Sub19) this.aClass5_Sub6_Sub4_1110.aNodeDeque373.head(); var2 != null; var2 = (Node_Sub19) this.aClass5_Sub6_Sub4_1110.aNodeDeque373.next()) {
            if (var1 < 0 || var2.anInt380 == var1) {
                if (var2.aClass5_Sub6_Sub2_1195 != null) {
                    var2.aClass5_Sub6_Sub2_1195.method589(Class105.anInt775 / 100);
    ...
    void method764(int var1, int var2, int var3) {
        ...
        Node_Sub16 var9 = (Node_Sub16) this.aNodeTable1112.lookup((long) this.anIntArray692[var1]);
        if (var9 != null) {
            Node_Sub10_Sub1 var6 = var9.aClass5_Sub10_Sub1Array1143[var2];
            if (var6 != null) {
                Node_Sub19 var7 = new Node_Sub19();
                var7.anInt380 = var1;
                var7.aNode_Sub16_1192 = var9;
                var7.aClass5_Sub10_Sub1_1194 = var6;
                var7.aClass139_1193 = var9.aClass139Array1139[var2];
                ...
                if (this.anIntArray1103[var1] == 0) {
                    var7.aClass5_Sub6_Sub2_1195 = Node_Sub6_Sub2.method597(var6, this.method773(var7), this.method760(var7), this.method772(var7));
                } else {
                    var7.aClass5_Sub6_Sub2_1195 = Node_Sub6_Sub2.method597(var6, this.method773(var7), 0, this.method772(var7));
    ...
    protected synchronized void method311(int[] var1, int var2, int var3) {
        if (this.aClass137_1111.method791()) {
            int var4 = this.aClass137_1111.anInt1121 * this.anInt378 * 1000000 / Class105.anInt775;
            ...
            do {
                ...
                var3 -= var7;
                this.method755();
            } while (this.aClass137_1111.method791());
        }

        this.aClass5_Sub6_Sub4_1110.method311(var1, var2, var3);
    }

    protected synchronized void method303(int var1) {
        if (this.aClass137_1111.method791()) {
            int var2 = this.aClass137_1111.anInt1121 * this.anInt378 * 1000000 / Class105.anInt775;
    ...
    int method773(Node_Sub19 var1) {
        ...
        Class139 var3 = var1.aClass139_1193;
        int var4;
        ...
        var4 = (int) ((double) (var1.aClass5_Sub10_Sub1_1194.anInt380 * 256) * Math.pow(2.0D, 3.255208333333333E-4D * (double) var2) / (double) Class105.anInt775 + 0.5D);
        return var4 < 1 ? 1 : var4;
    }

    protected synchronized Node_Sub6 method308() {
        return null;
    }
    ...
    public synchronized boolean method776(AudioTrack var1, ReferenceTable var2, Class97 var3, int var4) {
        ...
        for (Node_Sub14 var7 = (Node_Sub14) var1.aNodeTable1112.method314(); var7 != null; var7 = (Node_Sub14) var1.aNodeTable1112.method313()) {
            int var8 = (int) var7.key;
            Node_Sub16 var9 = (Node_Sub16) this.aNodeTable1112.lookup((long) var8);
            if (var9 == null) {
                var9 = Class7.method59(var2, var8);
                if (var9 == null) {
                    var5 = false;
                    continue;
                }

                this.aNodeTable1112.put(var9, (long) var8);
            }

            if (!var9.method805(var3, var7.aByteArray847, var6)) {
                var5 = false;
            }
        }
    ...
    public synchronized boolean method684() {
        return this.aClass137_1111.method791();
    }

    public synchronized void method775() {
        for (Node_Sub16 var1 = (Node_Sub16) this.aNodeTable1112.method314(); var1 != null; var1 = (Node_Sub16) this.aNodeTable1112.method313()) {
            var1.method23();
        }
    ...
    boolean method753(Node_Sub19 var1, int[] var2, int var3, int var4) {
        var1.anInt563 = Class105.anInt775 / 100;
        if (var1.anInt696 < 0 || var1.aClass5_Sub6_Sub2_1195 != null && !var1.aClass5_Sub6_Sub2_1195.method586()) {
            ...
            Class139 var6 = var1.aClass139_1193;
            boolean var7 = false;
            ++var1.anInt788;
    ...
    protected synchronized Node_Sub6 method307() {
    ...
    public synchronized void method766(AudioTrack var1, boolean var2) {
        this.method756();
        this.aClass137_1111.method793(var1.aByteArray503);
        this.aBoolean1109 = var2;
        this.aLong1106 = 0L;
        int var3 = this.aClass137_1111.method790();

        for (int var4 = 0; var4 < var3; ++var4) {
            this.aClass137_1111.method789(var4);
            this.aClass137_1111.method784(var4);
            this.aClass137_1111.method787(var4);
        }

        this.anInt694 = this.aClass137_1111.method786();
        this.anInt1105 = this.aClass137_1111.anIntArray1115[this.anInt694];
        this.aLong1098 = this.aClass137_1111.method780(this.anInt1105);
    }
    ...
    void method755() {
        ...
        long var3;
        for (var3 = this.aLong1098; var2 == this.anInt1105; var3 = this.aClass137_1111.method780(var2)) {
            while (var2 == this.aClass137_1111.anIntArray1115[var1]) {
                this.aClass137_1111.method789(var1);
                int var5 = this.aClass137_1111.method792(var1);
                if (var5 == 1) {
                    this.aClass137_1111.method788();
                    this.aClass137_1111.method787(var1);
                    if (this.aClass137_1111.method779()) {
                        ...
                        this.aClass137_1111.method782(var3);
                    }
                    break;
                }
                ...
                this.aClass137_1111.method784(var1);
                this.aClass137_1111.method787(var1);
            }

            var1 = this.aClass137_1111.method786();
            var2 = this.aClass137_1111.anIntArray1115[var1];
        }
    ...
    protected synchronized int method305() {
        return 0;
    }

    int method760(Node_Sub19 var1) {
        Class139 var2 = var1.aClass139_1193;
