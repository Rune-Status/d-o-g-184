...
public class HealthBar extends Node {
    static DoublyLinkedNode_Sub24_Sub4 aDoublyNode_Sub24_Sub4_848;
    LinkedList hitsplats;
    ...
    static int method696(IterableNodeTable var0, int var1, int var2) {
        if (var0 == null) {
            return var2;
        }
        IntegerNode var3 = (IntegerNode) var0.lookup((long) var1);
    ...
    static void method694(PathingEntity var0) {
        if (var0.forceMovementEndCycle == client.engineCycle
                || var0.animation == -1
                || var0.animationDelay != 0
                || var0.animationFrameCycle + 1 > Class57.getAnimationSequence(var0.animation).frameLengths[var0.animationFrame]) {
    ...
    void update(int cycle, int var2, int var3, int var4) {
        HitUpdate pending = null;
        int var6 = 0;

        for (HitUpdate h = (HitUpdate) this.hitsplats.head(); h != null; h = (HitUpdate) this.hitsplats.method658()) {
            ++var6;
            if (h.startCycle == cycle) {
                h.method271(cycle, var2, var3, var4);
                return;
            }
    ...
    HitUpdate method695(int var1) {
        HitUpdate var2 = (HitUpdate) this.hitsplats.head();
        if (var2 != null && var2.startCycle <= var1) {
            for (HitUpdate var3 = (HitUpdate) this.hitsplats.method658(); var3 != null && var3.startCycle <= var1; var3 = (HitUpdate) this.hitsplats.method658()) {
                var2.unlink();
                var2 = var3;
            }
