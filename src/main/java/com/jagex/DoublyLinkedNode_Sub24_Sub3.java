...
public abstract class DoublyLinkedNode_Sub24_Sub3 extends JagGraphics {
    public static DoublyLinkedNode_Sub24_Sub4[] aDoublyNode_Sub24_Sub4Array1573;
    static int anInt367;
    static String[] aStringArray1572;
    static int anInt386;
    static Random aRandom1575;
    static int anInt666;
    static int anInt366;
    static int anInt702;
    static int anInt788;
    ...
    static {
        ...
        anInt791 = 0;
        anInt563 = 0;
        aRandom1575 = new Random();
        aStringArray1572 = new String[100];
    }
    ...
    DoublyLinkedNode_Sub24_Sub3(byte[] var1, int[] var2, int[] var3, int[] var4, int[] var5, byte[][] var7) {
    ...
    DoublyLinkedNode_Sub24_Sub3(byte[] var1) {
        this.aByteArrayArray582 = new byte[256][];
        this.anInt375 = 0;
        this.method1167(var1);
    }
    ...
    static void method1159(byte[] var0, int var1, int var2, int var3, int var4, int var5) {
        int var6 = var1 + var2 * JagGraphics.drawingAreaWidth;
        int var7 = JagGraphics.drawingAreaWidth - var3;
        int var8 = 0;
        int var9 = 0;
        int var10;
        if (var2 < JagGraphics.drawingAreaTop) {
            ...
            var9 += var3 * var10;
            var6 += var10 * JagGraphics.drawingAreaWidth;
        }
        ...
        if (var3 + var1 > JagGraphics.drawingAreaBottom) {
            var10 = var3 + var1 - JagGraphics.drawingAreaBottom;
            var3 -= var10;
            var8 += var10;
            var7 += var10;
        }
        ...
        if (var3 > 0 && var4 > 0) {
            method1156(JagGraphics.drawingAreaPixels, var0, var5, var9, var6, var3, var4, var7, var8);
        }
    }
    ...
    static void method1148(byte[] var0, int var1, int var2, int var3, int var4, int var5, int var6) {
        int var7 = var1 + var2 * JagGraphics.drawingAreaWidth;
        int var8 = JagGraphics.drawingAreaWidth - var3;
        int var9 = 0;
        int var10 = 0;
        int var11;
        if (var2 < JagGraphics.drawingAreaTop) {
        ...
        if (var3 + var1 > JagGraphics.drawingAreaBottom) {
            var11 = var3 + var1 - JagGraphics.drawingAreaBottom;
            var3 -= var11;
            var9 += var11;
            var8 += var11;
        }
        ...
        if (var3 > 0 && var4 > 0) {
            method1158(JagGraphics.drawingAreaPixels, var0, var5, var10, var7, var3, var4, var8, var9, var6);
        }
    }
    ...
    public int method1145(String var1) {
        ...
        for (int var5 = 0; var5 < var1.length(); ++var5) {
            ...
            if (var6 == '<') {
                    ...
                    if (var7.equals("lt")) {
                        ...
                        if (!var7.equals("gt")) {
                            if (var7.startsWith("img=")) {
                                try {
                                    int var8 = TilePaint.method1501(var7.substring(4));
                ...
                if (var2 == -1) {
                    var4 += this.anIntArray1574[(char) (Entity.method10(var6) & 255)];
            ...
            if (var15 == '<') {
                ...
                if (var15 == '>' && var10 != -1) {
                    ...
                    if (var16.equals("br")) {
                        ...
                        try {
                            int var17 = TilePaint.method1501(var16.substring(4));
    ...
    void method1165(String var1, int var2, int var3) {
        ...
        for (int var6 = 0; var6 < var1.length(); ++var6) {
            if (var1.charAt(var6) != 0) {
                char var7 = (char) (Entity.method10(var1.charAt(var6)) & 255);
                if (var7 == '<') {
                    var4 = var6;
                } else {
                    int var9;
                        ...
                        if (var8.equals("lt")) {
                            ...
                            if (!var8.equals("gt")) {
                                if (var8.startsWith("img=")) {
                                    try {
                                        var9 = TilePaint.method1501(var8.substring(4));
                                        DoublyLinkedNode_Sub24_Sub4 var10 = aDoublyNode_Sub24_Sub4Array1573[var9];
    ...
    void method1163(String var1, int var2, int var3, int[] var4, int[] var5) {
        ...
        for (int var9 = 0; var9 < var1.length(); ++var9) {
            if (var1.charAt(var9) != 0) {
                char var10 = (char) (Entity.method10(var1.charAt(var9)) & 255);
                if (var10 == '<') {
                    var6 = var9;
                } else {
                    int var12;
                            ...
                            if (!var11.equals("gt")) {
                                if (var11.startsWith("img=")) {
                                    try {
                                        ...
                                        ++var8;
                                        var14 = TilePaint.method1501(var11.substring(4));
                                        DoublyLinkedNode_Sub24_Sub4 var15 = aDoublyNode_Sub24_Sub4Array1573[var14];
    ...
    int method1147(char var1) {
        ...
        return this.anIntArray1574[Entity.method10(var1) & 255];
    }

    void method1162(String var1) {
        try {
            if (var1.startsWith("col=")) {
                anInt788 = Class87.method466(var1.substring(4), 16);
            } else if (var1.equals("/col")) {
                anInt788 = anInt702;
            } else if (var1.startsWith("str=")) {
                anInt367 = Class87.method466(var1.substring(4), 16);
            } else if (var1.equals("str")) {
                anInt367 = 8388608;
            } else if (var1.equals("/str")) {
                anInt367 = -1;
            } else if (var1.startsWith("u=")) {
                anInt386 = Class87.method466(var1.substring(2), 16);
            } else if (var1.equals("u")) {
                anInt386 = 0;
            } else if (var1.equals("/u")) {
                anInt386 = -1;
            } else if (var1.startsWith("shad=")) {
                anInt696 = Class87.method466(var1.substring(5), 16);
    ...
    public void method1152(String var1, int var2, int var3, int var4, int var5) {
        if (var1 != null) {
            this.method1160(var4, var5);
